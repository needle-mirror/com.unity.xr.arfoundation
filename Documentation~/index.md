...
| **Meta Quest**   | [Unity OpenXR: Meta](xref:meta-openxr-manual) and/or [Unity OpenXR: Spatial Entities](xref:spatialentities-openxr-manual) |
| **Android XR**   | [Unity OpenXR: Android XR](xref:androidxr-openxr-manual) and/or [Unity OpenXR: Spatial Entities](xref:spatialentities-openxr-manual) |
...
| **Feature**                                                        | Android | iOS | visionOS | Meta Quest | Android XR | Spatial Entities | XR Simulation |
| :----------------------------------------------------------------- | :-----: |:---:| :------: | :--------: | :--------: | :--------------: | :-----------: |
...
| [Markers](xref:arfoundation-markers)                               |         |     |          |            |            |      Yes         |               |
