...
To use [ARCameraBackground](xref:UnityEngine.XR.ARFoundation.ARCameraBackground) with URP, you must enable the **AR Background Renderer Feature**. See [Universal Render Pipeline](xref:arfoundation-universal-render-pipeline) for more information.
