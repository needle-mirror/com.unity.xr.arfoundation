...
- Changed the Transform hierarchy of trackable GameObjects spawned by [Manager](xref:arfoundation-managers) components to reflect the scene hierarchy reported by the provider.
