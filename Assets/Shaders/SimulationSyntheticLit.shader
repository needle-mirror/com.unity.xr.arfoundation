Shader "Hidden/Simulation/Synthetic Lit"
{
    ...
    SubShader
    {
        ...
        UsePass "Hidden/Simulation/URP/Synthetic/ForwardLit"
        UsePass "Hidden/Simulation/URP/Synthetic/ShadowCaster"
        UsePass "Hidden/Simulation/URP/Synthetic/DepthOnly"
        // This pass it not used during regular rendering, only for lightmap baking.
        UsePass "Universal Render Pipeline/Lit/Meta"
        UsePass "Hidden/Simulation/URP/Synthetic/Universal2D"
    }

    Fallback "Hidden/Simulation/Legacy/Synthetic"
