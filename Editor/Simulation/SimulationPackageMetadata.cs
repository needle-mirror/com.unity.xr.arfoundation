...
namespace UnityEditor.XR.Simulation
{
    class XRPackage : IXRPackage
    {
        ...
        static IXRPackageMetadata s_Metadata = new SimulationPackageMetadata()
        {
            ...
            settingsType = typeof(XRSimulationRuntimeSettings).FullName,
        ...
        public bool PopulateNewSettingsInstance(ScriptableObject obj)
        {
            ...
            if (obj is XRSimulationRuntimeSettings settings)
                EditorBuildSettings.AddConfigObject(XRSimulationRuntimeSettings.k_SettingsKey, settings, true);
