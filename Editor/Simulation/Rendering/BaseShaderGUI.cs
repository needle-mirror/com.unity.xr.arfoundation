...
{
    /// <summary>
    /// Modified version of UnityEditor.Rendering.Universal.ShaderGUI.BaseShaderGUI for use in custom material inspector
    /// when using built-in renderer.
    /// </summary>
    abstract class BaseShaderGUI : ShaderGUI
    {
        // Stub in of SavedParameter.cs SavedBool
        ...
        SavedBool m_SurfaceOptionsFoldout = new SavedBool("SurfaceOptions", true);

        SavedBool m_SurfaceInputsFoldout = new SavedBool("SurfaceInputs", true);

        SavedBool m_AdvancedFoldout  = new SavedBool("Advanced", false);
        #endregion
