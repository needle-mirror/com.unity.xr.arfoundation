...
namespace UnityEngine.XR.ARSubsystems
{
    ...
    public interface ITrackable
    {
        ...
        /// <example>
        /// Some `ITrackable` implementations are MonoBehaviours, and you can use the Transform component of their
        ...
        /// using the example code below, assuming the XR Origin has a uniform scale of (1, 1, 1):
        /// <code>
