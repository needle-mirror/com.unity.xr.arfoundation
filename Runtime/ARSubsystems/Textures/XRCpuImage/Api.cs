...
namespace UnityEngine.XR.ARSubsystems
{
    public partial struct XRCpuImage
    {
        ...
        /// </summary>
        /// <remarks>
        /// This interface is intended to be implemented by AR platform providers (for example, ARCore, ARKit,
        /// and Open XR). The <see cref="XRCpuImage"/> uses it to make platform-specific API calls. Unity developers
