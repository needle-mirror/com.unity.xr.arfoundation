...
namespace UnityEngine.XR.ARSubsystems
{
    ...
    public class BoundedPlaneBuilder
    {
        ...
        /// <summary>
        /// Copies values from another BoundedPlane to this instance.
        /// </summary>
        /// <param name="boundedPlane">The BoundedPlane values to copy to this instance.</param>
        /// <returns>This instance.</returns>
        public BoundedPlaneBuilder FromBoundedPlane(BoundedPlane boundedPlane)
        {
            m_TrackableId = boundedPlane.trackableId;
            m_Pose = boundedPlane.pose;
            m_TrackingState = boundedPlane.trackingState;
            m_NativePtr = boundedPlane.nativePtr;
            m_Size = boundedPlane.size;
            m_Alignment = boundedPlane.alignment;
            m_Center = boundedPlane.center;
            m_Classifications = boundedPlane.classifications;
            m_ParentId = boundedPlane.parentId;
            return this;
        }
